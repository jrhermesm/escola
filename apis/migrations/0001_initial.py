# Generated by Django 4.2.11 on 2024-05-23 00:47
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "descricao",
                    models.TextField(
                        db_column="ecursodescricao", db_comment="Descrição do curso"
                    ),
                ),
                (
                    "publico_alvo",
                    models.TextField(
                        db_column="ecursopublico", db_comment="Público alvo do curso"
                    ),
                ),
                (
                    "carga_horaria",
                    models.IntegerField(
                        db_column="acursocarga", db_comment="Carga horaria do curso"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "inicio",
                    models.DateField(
                        db_column="dturmainicio", db_comment="Data do início da turma"
                    ),
                ),
                (
                    "final",
                    models.DateField(
                        db_column="dturmafinal", db_comment="Data do final da turma"
                    ),
                ),
                (
                    "horario",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "descricao",
                    models.TextField(
                        db_column="etrilhdescricao", db_comment="Descrição da trilha"
                    ),
                ),
                (
                    "publico_alvo",
                    models.TextField(
                        db_column="etrilhpublico", db_comment="Público alvo da trilha"
                    ),
                ),
                (
                    "carga_horaria",
                    models.IntegerField(
                        db_column="atrilhcarga", db_comment="Carga horaria da trilha"
                    ),
                ),
            ],
            options={
